...
import { GinDrinksArray } from './AllRecipes';
...
const ginDrinks = [
    GinDrinksArray.map((drinkName => 
        drinkName
    ))
]

const [ginDrinksToSend] = React.useState(ginDrinks);
      
let ginDrinksListed = GinDrinksArray.map((item, i) => (

...
import { RumDrinksArray } from './AllRecipes';
...
const rumDrinks = [
    RumDrinksArray.map((drinkName => 
        drinkName
    ))
]

const [rumDrinksToSend] = React.useState(rumDrinks);
      

let rumDrinksListed = RumDrinksArray.map((item, i) => (

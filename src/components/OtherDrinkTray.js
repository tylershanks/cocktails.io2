...
import { OtherDrinksArray } from './AllRecipes';
...
const otherDrinks = [
    OtherDrinksArray.map((drinkName => 
        drinkName
    ))
]

const [otherDrinksToSend] = React.useState(otherDrinks);
      
let otherDrinksListed = OtherDrinksArray.map((item, i) => (

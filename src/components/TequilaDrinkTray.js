...
import { TequilaDrinksArray } from './AllRecipes';
...
const tequilaDrinks = [
    TequilaDrinksArray.map((drinkName => 
        drinkName
    ))
]

const [tequilaDrinksToSend] = React.useState(tequilaDrinks);
      
let tequilaDrinksListed = TequilaDrinksArray.map((item, i) => (
    ...
    return (
        <>
        <div className='TequilaDrinkTray'>
            {/* Tequila Drinks */}
...
export default TequilaDrinkTray;